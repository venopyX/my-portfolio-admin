...
export default {
  ...
  setup() {
    ...
    const socialIcons = [
      ...
      { name: 'CodeSandbox', icon: 'fas fa-cube' },
      { name: 'NPM', icon: 'fab fa-npm' },
      { name: 'PyPI', icon: 'fab fa-python' },
      { name: 'RubyGems', icon: 'fas fa-gem' },
      { name: 'Docker Hub', icon: 'fab fa-docker' },
      { name: 'Kaggle', icon: 'fas fa-brain' },
      { name: 'LeetCode', icon: 'fas fa-code' },
      { name: 'HackerRank', icon: 'fab fa-hackerrank' },
      { name: 'CodeChef', icon: 'fas fa-code' },
      { name: 'Codeforces', icon: 'fas fa-laptop-code' },
      { name: 'Exercism', icon: 'fas fa-dumbbell' },
      { name: 'Replit', icon: 'fas fa-terminal' },
      { name: 'StackBlitz', icon: 'fas fa-bolt' },
      { name: 'Gist', icon: 'fab fa-github' },
      ...
      { name: 'Bluesky', icon: 'fas fa-cloud' },
      { name: 'Threads', icon: 'fas fa-at' },
    ...
    const socialStyles = [
      ...
      { name: 'GitLab Style', class: 'bg-[#FC6D26]' },
      { name: 'Bitbucket Style', class: 'bg-[#0052CC]' },
      { name: 'Stack Overflow Style', class: 'bg-[#F48024]' },
      { name: 'Dev.to Style', class: 'bg-[#0A0A0A]' },
      { name: 'Medium Style', class: 'bg-[#00AB6C]' },
      { name: 'Hashnode Style', class: 'bg-[#2962FF]' },
      { name: 'CodePen Style', class: 'bg-[#000000]' },
      { name: 'CodeSandbox Style', class: 'bg-[#151515]' },
      { name: 'NPM Style', class: 'bg-[#CB3837]' },
      { name: 'PyPI Style', class: 'bg-[#3775A9]' },
      { name: 'RubyGems Style', class: 'bg-[#E9573F]' },
      { name: 'Docker Hub Style', class: 'bg-[#2496ED]' },
      { name: 'Kaggle Style', class: 'bg-[#20BEFF]' },
      { name: 'LeetCode Style', class: 'bg-[#FFA116]' },
      { name: 'HackerRank Style', class: 'bg-[#2EC866]' },
      { name: 'CodeChef Style', class: 'bg-[#5B4638]' },
      { name: 'Codeforces Style', class: 'bg-[#1F8ACB]' },
      { name: 'Exercism Style', class: 'bg-[#009CAB]' },
      { name: 'Replit Style', class: 'bg-[#667881]' },
      { name: 'StackBlitz Style', class: 'bg-[#1269D3]' },
      { name: 'Gist Style', class: 'bg-[#333333]' },
      { name: 'Discord Style', class: 'bg-[#5865F2]' },
      { name: 'Twitch Style', class: 'bg-[#9146FF]' },
      { name: 'YouTube Style', class: 'bg-[#FF0000]' },
      { name: 'Twitter Style', class: 'bg-[#1DA1F2]' },
      { name: 'Mastodon Style', class: 'bg-[#6364FF]' },
      { name: 'Reddit Style', class: 'bg-[#FF4500]' },
      { name: 'Bluesky Style', class: 'bg-[#0085FF]' },
      { name: 'Threads Style', class: 'bg-[#000000]' },
      { name: 'Instagram Style', class: 'bg-[#E4405F]' },
      { name: 'Facebook Style', class: 'bg-[#1877F2]' },
      { name: 'VK Style', class: 'bg-[#4A76A8]' },
      { name: 'Weibo Style', class: 'bg-[#DF2029]' },
      { name: 'WhatsApp Style', class: 'bg-[#25D366]' },
      { name: 'Telegram Style', class: 'bg-[#26A5E4]' }
    ];
